...
useEffect(() => {
   ...
   gsap.fromTo(el4 , {delay:3, opacity:0, translateX:"-10px"} , {delay:3, opacity:1,translateX:"1px", duration: 3, scrollTrigger:{
    trigger: el4,
   }})
   const el5 = content2.current;
   gsap.fromTo(el5 , {delay:3, opacity:0, translateX:"-10px"} , {delay:3, opacity:1,translateX:"1px", duration: 3, scrollTrigger:{
    trigger: el5,
   }})
   const el6 = content3.current;
   gsap.fromTo(el6 , {delay:3, opacity:0, translateX:"-10px"} , {delay:3, opacity:1,translateX:"1px", duration: 3, scrollTrigger:{
    trigger: el6,
   }})
}, [ ] )
        ...
        <div className='grid gap-10 md:gap-12 lg:gap-20 grid-cols-1 md:grid-cols-3 mx-auto mt-10 md:mt-20 lg:ml-32 lg:mr-32 ml-12 mr-12'>
            ...
            <div>
                ...
                <div className='leading-loose' >
                    ...
                    <span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas magni at laudantium velit ipsum perspiciatis provident similique quasi quaerat quos,</span>
                </div>
            </div>
