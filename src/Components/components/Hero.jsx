...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      el2,
      { delay: 2, opacity: 0, translateX: '-10px' },
      {
        delay: 1,
        opacity: 1,
        translateX: '1px',
    ...
    gsap.fromTo(
      el5,
      { delay: 2, opacity: 0, translateY: '10px' },
      {
        delay: 2,
        opacity: 1,
        translateY: '1px',
  ...
  return (
    <div
      className="flex flex-col lg:flex-row justify-center items-center  md:mt-0 bg-gradient-to-r from-amber-300 via-[#fff7ed] to-[#fff7ed]"
      id="Home"
    >
      <div className="w-full lg:w-1/2  pl-10 pr-10 order-2 lg:order-1  flex flex-col text-[#1e1b4b]  ">
        <h1
          className="text-5xl font-bold lg:text-9xl md:text-7xl lg:mb-10 text-center sm:text-left "
          ref={heading}
        >
          {' '}
          ignyte{' '}
